...
export default function Avatar({ status, persona = 'global_pro' }: AvatarProps) {
    return (
        <div className="relative w-full h-full bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-800 shadow-2xl flex items-center justify-center p-8 text-center group">
            ...
            <div className="z-10 flex flex-col items-center">
                ...
                <div className="w-40 h-40 bg-zinc-800 rounded-full mb-6 border-4 border-zinc-700 flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                    <div className="text-4xl">🤖</div>
                </div>

                <div className="space-y-2">
                    <h3 className="text-zinc-500 text-xs font-bold uppercase tracking-[0.2em]">Persona: {persona}</h3>
                    <div className="text-2xl font-black text-white capitalize leading-tight">
