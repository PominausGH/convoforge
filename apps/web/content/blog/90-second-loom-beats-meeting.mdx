...
Anything emotional. [Hard feedback](/blog/sbi-feedback-that-lands), conflict, [tense decisions](/blog/start-difficult-conversations-avoiding). The moment empathy matters, you need bidirectional video in real time. Loom is for decisions and transfer of information. The relationship-shaping stuff still belongs on a synchronous call.
